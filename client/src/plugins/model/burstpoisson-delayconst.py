...
class BurstConstDelayPoisson(IModelPlugin):
	"""
		...
		The wait period (delay) is a constant.
		The interval between each request in a burst is calculated based on the rate in a poisson distribution.
	"""
	...
	def get_interval(self):
		rate = self.configuration.get("interval_rate")
		if not rate:
